            ...
            <div className="footer__cols">
                ...
                <h4 className="footer__col-title">HOURS</h4>
                    <div className="footer__col-hours">
                        <h5 className="footer__col-heading">TUESDAY - THURSDAY</h5>
                        <p className="footer__col-text">11:30AM - 3PM | 5PM - 9:30PM</p>
                        <h5 className="footer__col-heading">FRIDAY - SATURDAY</h5>
                        <p className="footer__col-text">11:30AM - 3PM | 5PM - 10:30PM</p>
                        <h5 className="footer__col-heading">MONDAY - SUNDAY</h5>
                ...
                <section className="footer__col">
                    ...
                    <h4 className="footer__col-title footer__top-spacing">SOCIAL</h4>
